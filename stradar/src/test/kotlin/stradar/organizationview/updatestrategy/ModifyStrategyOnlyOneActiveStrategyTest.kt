 ...
 */
class ModifyStrategyOnlyOneActiveStrategyTest {
        ...
        fun `Modify Strategy Only One Active Strategy Test`() {
                ...
                var strategyBuilderId: String =
                        "12ddd4cc-d8ae-4b70-b74e-de5541eb5671-STRATEGY-BUILDER"
                ...
                events.add(
                        StrategyCreatedEvent(
                                ...
                                organizationId =
                                        UUID.fromString("3d2730fc-26f8-4d22-a03e-655f31a0ad6c"),
                                strategyId =
                                        UUID.fromString("38248734-48b7-4310-ad09-fc833834d5ab"),
                ...
                events.add(
                        StrategyCreatedEvent(
                                ...
                                organizationId =
                                        UUID.fromString("3d2730fc-26f8-4d22-a03e-655f31a0ad6c"),
                                strategyId =
                                        UUID.fromString("11111111-48b7-4310-ad09-fc8338111111"),
                ...
                fixture.given(events)
                        .`when`(
                                command,
                                MetaData.with(ORGANIZATION_ID_HEADER, command.organizationId)
                        )
